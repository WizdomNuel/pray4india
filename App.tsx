            ...
            <div className="space-y-6 md:space-y-12">
              ...
              <div className="pt-6 md:pt-14 border-t border-slate-100 dark:border-slate-800 flex items-center gap-4 md:gap-10">
                ...
                <div className="min-w-0">
                  <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{t.contact.support}</div>
                  <a href="mailto:wisdomnuelmmesoma@gmail.com" className="text-xs md:text-[10px] lg:text-[12px] font-bold uppercase truncate sm:whitespace-normal">wisdomnuelmmesoma@gmail.com</a>
                </div>
              </div>
            </div>
