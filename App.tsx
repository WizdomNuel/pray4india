              ...
              <AnimatePresence mode="wait">
                {formStatus === 'success' ? (
                  ...
                  <form onSubmit={handleJoinSubmit} className="space-y-6 md:space-y-10">
                    ...
                    <button type="submit" disabled={formStatus === 'submitting'} className="w-full py-4 md:py-6 bg-orange-600 text-white font-bold rounded-2xl hover:bg-orange-700 transition-all shadow-xl flex items-center justify-center gap-0 md:gap-2 text-lg lg:text-xl uppercase tracking-widest">
